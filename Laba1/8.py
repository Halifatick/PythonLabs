...
# дополнить 28 нулями, чтобы в итоге был массив из 28. 2^8 =128 элементов
# (ближайшая степень двойки к 100 – это число 128, к 35 – это 64 и т.д.).

from random import randint
import math

array = [randint(0, 100) for i in range(randint(0, 10000))]
print('В начале работы скрипта элементов: ', len(array))
Pow = math.ceil(math.log2(len(array)))  # ceil - округление в бОльшую сторону
[array.append(randint(0, 100)) for _ in range(len(array), 2 ** Pow)]
